          ...
          ui.onDialogShown(self.$dialog, function () {
            ...
            $editBtn.click( function (e) {
              ...
              deferred.resolve({
                ...
                if ($img.parent('figure').length && captionText) {
                    $img.next('figcaption').remove();
                    $img.unwrap('figure');

                    $newFigure = $img.wrap('<figure class="figure"></figure>').parent();
                    $img.after('<figcaption class="figure-caption text-center text-muted"><em>' + captionText + '</em></figcaption>');
