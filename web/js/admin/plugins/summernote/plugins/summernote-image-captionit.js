            ...
            context.memo('button.captionIt', function () {
                var button=ui.button({
                    ...
                    click: function () {
                        ...
                        var $parentAnchorLink = img;
                        if ($parentAnchorLink.next('figcaption').length) {
                            $parentAnchorLink.next('figcaption').remove();
                            $parentAnchorLink.unwrap();
                        } else {
                            ...
                            if (captionText) {
                                var figure = $('<figure class="wp-caption"></figure>');
                                figure.attr('style', img.attr('style'));
                                if(img.attr('class') !== undefined) {
                                    var classes = figure.attr('class') + ' ' + img.attr('class');
                                }
                                figure.attr('class', classes);
                                figure.width(img[0].width);
                                img.wrap(figure);
                                img.after('<figcaption style="text-align: center" class="' + options.captionIt.figcaptionClass + '">' + '<em>' + captionText + '</em>' + '</figcaption>');
                            }
                        }
                    }
                });
